...
import com.mycompany.lab4parsa.util.JsfUtil;
import com.mycompany.lab4parsa.util.PaginationHelper;
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private com.mycompany.lab4parsa.AppUserFacade ejbFacade;
